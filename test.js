...
const deserializedStuffWithDuplicates = deserialize(serializedStuffWithDuplicates, {X, Y})
assert(deserializedStuffWithDuplicates.bleh === deserializedStuffWithDuplicates.bluh)
